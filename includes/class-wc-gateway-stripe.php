...
class WC_Gateway_Stripe extends WC_Stripe_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->publishable_key      = Marketing_360_Payments::get_stripe_key();
        $this->merchant_id			= Marketing_360_Payments::get_stripe_id();
        $this->client_id 			= Marketing_360_Payments::get_client_id();
        $this->client_secret 		= Marketing_360_Payments::get_client_secret();
        ...
        add_filter('woocommerce_after_settings_checkout', array($this, 'render_signin_popup'), 10, 2);
    ...
    public function payment_scripts()
    {
        ...
        // If no SSL bail.
        if (! is_ssl()) {
            WC_Stripe_Logger::log('Marketing 360® Payments live mode requires SSL.');
            return;
        }
        ...
        wp_register_style('stripe_styles', plugins_url('assets/css/stripe-styles.css', WC_M360_PAYMENTS_MAIN_FILE), array(), WC_M360_PAYMENTS_VERSION);
        wp_enqueue_style('stripe_styles');

        wp_register_script('stripe', 'https://js.stripe.com/v3/', '', '3.0', true);
        wp_register_script('woocommerce_stripe', plugins_url('assets/js/stripe' . $suffix . '.js', WC_M360_PAYMENTS_MAIN_FILE), array( 'jquery-payment', 'stripe' ), WC_M360_PAYMENTS_VERSION . time(), true);
