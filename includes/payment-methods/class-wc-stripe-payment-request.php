...
class WC_Stripe_Payment_Request
{
    ...
    public function init()
    {
        ...
        add_action('woocommerce_payment_method_checkout_before_submit', [ $this, 'display_payment_request_button_html' ], 1);
        add_action('woocommerce_payment_method_checkout_before_submit', [ $this, 'display_payment_request_button_separator_html' ], 2);
    ...
    public function scripts()
    {
        ...
        wp_register_script('wc_stripe_payment_request', plugins_url('assets/js/stripe-payment-request' . $suffix . '.js', WC_M360_PAYMENTS_MAIN_FILE), array( 'jquery', 'stripe' ), WC_M360_PAYMENTS_VERSION . time(), true);
