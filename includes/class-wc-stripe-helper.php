...
class WC_Stripe_Helper {
	...
	public static function get_localized_messages() {
		return apply_filters(
			...
			array(
				'invalid_number'           => __( 'The card number is not a valid credit card number.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_expiry_month'     => __( 'The card\'s expiration month is invalid.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_expiry_year'      => __( 'The card\'s expiration year is invalid.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_cvc'              => __( 'The card\'s security code is invalid.', 'woocommerce-gateway-marketing-360-payments' ),
				'incorrect_number'         => __( 'The card number is incorrect.', 'woocommerce-gateway-marketing-360-payments' ),
				'incomplete_number'        => __( 'The card number is incomplete.', 'woocommerce-gateway-marketing-360-payments' ),
				'incomplete_cvc'           => __( 'The card\'s security code is incomplete.', 'woocommerce-gateway-marketing-360-payments' ),
				'incomplete_expiry'        => __( 'The card\'s expiration date is incomplete.', 'woocommerce-gateway-marketing-360-payments' ),
				'expired_card'             => __( 'The card has expired.', 'woocommerce-gateway-marketing-360-payments' ),
				'incorrect_cvc'            => __( 'The card\'s security code is incorrect.', 'woocommerce-gateway-marketing-360-payments' ),
				'incorrect_zip'            => __( 'The card\'s zip code failed validation.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_expiry_year_past' => __( 'The card\'s expiration year is in the past', 'woocommerce-gateway-marketing-360-payments' ),
				'card_declined'            => __( 'The card was declined.', 'woocommerce-gateway-marketing-360-payments' ),
				'missing'                  => __( 'There is no card on a customer that is being charged.', 'woocommerce-gateway-marketing-360-payments' ),
				'processing_error'         => __( 'An error occurred while processing the card.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_request_error'    => __( 'Unable to process this payment, please try again or use alternative method.', 'woocommerce-gateway-marketing-360-payments' ),
				'invalid_sofort_country'   => __( 'The billing country is not accepted by SOFORT. Please try another country.', 'woocommerce-gateway-marketing-360-payments' ),
				'email_invalid'            => __( 'Invalid email address, please correct and try again.', 'woocommerce-gateway-marketing-360-payments' ),
			)
		);
	}
