...
class WC_Stripe_Helper {
	...
	public static function get_localized_messages() {
		return apply_filters(
			...
			array(
				'invalid_number'           => __( 'The card number is not a valid credit card number.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_expiry_month'     => __( 'The card\'s expiration month is invalid.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_expiry_year'      => __( 'The card\'s expiration year is invalid.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_cvc'              => __( 'The card\'s security code is invalid.', 'marketing-360-payments-for-woocommerce' ),
				'incorrect_number'         => __( 'The card number is incorrect.', 'marketing-360-payments-for-woocommerce' ),
				'incomplete_number'        => __( 'The card number is incomplete.', 'marketing-360-payments-for-woocommerce' ),
				'incomplete_cvc'           => __( 'The card\'s security code is incomplete.', 'marketing-360-payments-for-woocommerce' ),
				'incomplete_expiry'        => __( 'The card\'s expiration date is incomplete.', 'marketing-360-payments-for-woocommerce' ),
				'expired_card'             => __( 'The card has expired.', 'marketing-360-payments-for-woocommerce' ),
				'incorrect_cvc'            => __( 'The card\'s security code is incorrect.', 'marketing-360-payments-for-woocommerce' ),
				'incorrect_zip'            => __( 'The card\'s zip code failed validation.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_expiry_year_past' => __( 'The card\'s expiration year is in the past', 'marketing-360-payments-for-woocommerce' ),
				'card_declined'            => __( 'The card was declined.', 'marketing-360-payments-for-woocommerce' ),
				'missing'                  => __( 'There is no card on a customer that is being charged.', 'marketing-360-payments-for-woocommerce' ),
				'processing_error'         => __( 'An error occurred while processing the card.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_request_error'    => __( 'Unable to process this payment, please try again or use alternative method.', 'marketing-360-payments-for-woocommerce' ),
				'invalid_sofort_country'   => __( 'The billing country is not accepted by SOFORT. Please try another country.', 'marketing-360-payments-for-woocommerce' ),
				'email_invalid'            => __( 'Invalid email address, please correct and try again.', 'marketing-360-payments-for-woocommerce' ),
			)
		);
	}
